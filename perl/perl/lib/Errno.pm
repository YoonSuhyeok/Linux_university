...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEBADF WSAENOBUFS WSAEINPROGRESS WSAETOOMANYREFS WSAEPROCLIM
	WSAEADDRINUSE WSAECONNRESET WSAEDESTADDRREQ WSAENOTSOCK
	WSAEPFNOSUPPORT WSAEREMOTE WSAENOPROTOOPT WSAELOOP WSAESOCKTNOSUPPORT
	WSAETIMEDOUT WSAEALREADY WSAEADDRNOTAVAIL WSAEWOULDBLOCK
	WSAECONNREFUSED WSAEHOSTUNREACH WSAEFAULT WSAECANCELLED WSAENOTEMPTY
	WSAEREFUSED WSAEACCES WSAESTALE WSAEUSERS WSAECONNABORTED WSAEMSGSIZE
	WSAEINTR WSAEINVAL WSAENOMORE WSAEINVALIDPROCTABLE WSAENETUNREACH
	WSAEPROTONOSUPPORT WSAENETRESET WSAENETDOWN WSAEAFNOSUPPORT WSAEMFILE
	WSAEDQUOT WSAENAMETOOLONG WSAEOPNOTSUPP WSAENOTCONN WSAEISCONN
	WSAEDISCON WSAEPROVIDERFAILEDINIT WSAEPROTOTYPE WSAEINVALIDPROVIDER
	WSAESHUTDOWN WSAEHOSTDOWN
    )],
);
